#ifndef GRAPH_SYSTEMS_CORE_APPS_WCC_EDGECUT_APP_H_
#define GRAPH_SYSTEMS_CORE_APPS_WCC_EDGECUT_APP_H_
...
class WCCEdgeCutApp : public apis::PlanarAppBase<CSRGraph> {
 ...
 public:
  ...
  WCCEdgeCutApp() = default;
  explicit WCCEdgeCutApp(
      common::TaskRunner* runner,
      update_stores::BspUpdateStore<VertexData, EdgeData>* update_store,
      data_structures::Serializable* graph);
  ~WCCEdgeCutApp() override = default;
 ...
 private:
  ...
  void WriteEdgeCutAllBorderOut(VertexID id, VertexData data);
