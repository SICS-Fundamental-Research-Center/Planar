#ifndef GRAPH_SYSTEMS_EXECUTOR2_H
#define GRAPH_SYSTEMS_EXECUTOR2_H
...
class Executor2 : public Component {
 public:
  Executor2(scheduler::MessageHub* hub)
...
#endif  // GRAPH_SYSTEMS_EXECUTOR2_H
