...
$partitioner_path -i $tempcsr_path -o $partition_result_path -partitioner bfsedgecut -store_strategy unconstrained -n_partitions 2 -max_vertex_num_per_partition 4
